...
function HeroSection() {
  ...
  const searchJobHandler = () => {
    //console.log("Search query: ", query);  Log the search query when search button is clicked
  ...
  return (
    <div className="text-center">
      ...
      <span className="px-4 py-4 rounded-full bg-gray-100 text-[#F83002] font-medium">
      ...
      {/* Search Bar */}
      <div className="flex w-[40%] shadow-lg border-gray-200 p-3 rounded items-center gap-4 mx-auto ">
        <input
          type="text"
