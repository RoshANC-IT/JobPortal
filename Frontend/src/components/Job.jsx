...
function Job({ job }) {
  ...
  // Improved function to handle day calculations
  ...
  return (
    <div className="p-5 rounded-md shadow-xl bg-white border-gray-100 grid grid-cols-1 gap-4">
      {/* Header Section */}
      ...
      <div className="flex items-center gap-4 mt-4">
        ...
        <Button className="bg-[#7209b7] rounded-xl" aria-label="Save job for later">
          Save for Later
        </Button>
      </div>
    </div>
